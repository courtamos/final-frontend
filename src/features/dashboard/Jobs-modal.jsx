              ...
              <DialogContent dividers>
                <div className="modal-top">
                  ...
                  <div className="modal-top-right">
                    <TextField id="standard-basic" label="Company Name" className="content" name="company" value={company} onChange={(event) => setCompany(event.target.value)} />
                    ...
                    <TextField id="standard-basic" label="Job Title" className="content" name="title" value={title} onChange={(event) => setTitle(event.target.value)} />
